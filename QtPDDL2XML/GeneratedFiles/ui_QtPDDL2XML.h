...
public:
    ...
    QPushButton *showDomainDataButton;
    QLabel *label_4;
    ...
    QPushButton *showProblemDataBox;
    ...
    void setupUi(QMainWindow *QtPDDL2XMLClass)
    {
        ...
        showDomainDataButton = new QPushButton(page);
        showDomainDataButton->setObjectName(QString::fromUtf8("showDomainDataButton"));
        showDomainDataButton->setGeometry(QRect(430, 210, 81, 31));
        showDomainDataButton->setFont(font1);
        ...
        layoutWidget->setGeometry(QRect(150, 140, 251, 161));
        ...
        showProblemDataBox = new QPushButton(page_2);
        showProblemDataBox->setObjectName(QString::fromUtf8("showProblemDataBox"));
        showProblemDataBox->setGeometry(QRect(420, 220, 81, 31));
        showProblemDataBox->setFont(font1);
        ...
        layoutWidget2->setGeometry(QRect(130, 140, 271, 171));
    ...
    void retranslateUi(QMainWindow *QtPDDL2XMLClass)
    {
        ...
        showDomainDataButton->setText(QApplication::translate("QtPDDL2XMLClass", "\346\230\276\347\244\272\346\225\260\346\215\256", nullptr));
        ...
        showProblemDataBox->setText(QApplication::translate("QtPDDL2XMLClass", "\346\230\276\347\244\272\346\225\260\346\215\256", nullptr));
